...
namespace NHibernate.CMS.Framework.Utility
{
    ...
    public class SerializationHelper
    {
        ...
        public static object XmlDeserializeFromFile(System. Type type, string filename)
        {
            FileStream fs = null;
            try
            {
        ...
        public static object XmlDeserialize(System.Type type, string xmlStr)
        {
        ...
        public static object DataContractDeserialize(System.Type type, string xmlStr)
        {
            if (xmlStr == null || xmlStr.Trim() == "")
            {
                return null;
        ...
        /// <param name="json">符合JSON格式的字符串</param>
        /// <returns>T类型的对象</returns>
        public static object JsonDeserialize(System.Type type, string json)
        {
            if (json == null)
            {
                return null;
