...
namespace NHibernate.CMS.Framework.Utility
{
     ...
     public  class FtplibHelper
    {
        private static string ftpServerIP = AppSettingsHelper.GetString("ftpServerIP");//FTP连接地址
        private static string ftpRemotePath = AppSettingsHelper.GetString("ftpRemotePath");//FTP连接地址
        private static string ftpUserID = AppSettingsHelper.GetString("ftpAccount");   //ftp用户名
        private static string ftpPassword = AppSettingsHelper.GetString("ftPassword");   //ftp密码
        private static string ftpURI = "ftp://" + ftpServerIP+"/";
        public FtplibHelper()
        {
        ...
        public static void Upload(string filename)
        {
            ...
            catch (Exception ex)
            {
                 ...
                 LogHelper.WriteLog("Ftp上传 Error --> " + ex.Message);
            }
        }
        ...
        public static void Upload(string filename, string objPath = "")
        {
            string url = ftpURI;
            if (objPath != "")
                url += objPath + "/";
        ...
        /// 下载
        /// </summary>
        /// <param name="filePath">下载到本地路径 如:d://ftp/1.png</param>
        /// <param name="fileName">远程文件名称需带路径如 ftp:129.12.0.14/ftp/s/1.png; 那么就是ftp/s/1.png</param>
        public static void Download(string filePath, string fileName)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("Ftp下载 Error --> " + ex.Message);
            }
        }
        ...
        public static void Delete(string fileName)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("Ftp删除 Error --> " + ex.Message + "  文件名:" + fileName);
            }
        }
        ...
        public static void RemoveDirectory(string folderName)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("Ftp删除 Error --> " + ex.Message + "  文件名:" + folderName);
            }
        }
        ...
        public static string[] GetFilesDetailList()
        {
            ...
            try
            {
                ...
                StreamReader reader = new StreamReader(response.GetResponseStream(), Encoding.UTF8);//Default
            ...
            {
                downloadFiles = null;
                LogHelper.WriteLog("Ftp获取文件 Error --> " + ex.Message ); 
        ...
        /// </summary>
        /// <returns></returns>
        public static string[] GetFilesDetailList(string mask)
        {
            string[] downloadFiles;
            try
            {
                StringBuilder result = new StringBuilder();
                FtpWebRequest ftp;
                ftp = (FtpWebRequest)FtpWebRequest.Create(new Uri(ftpURI + mask));
                ftp.Credentials = new NetworkCredential(ftpUserID, ftpPassword);
                ftp.Method = WebRequestMethods.Ftp.ListDirectoryDetails;//
                WebResponse response = ftp.GetResponse();
                StreamReader reader = new StreamReader(response.GetResponseStream(), Encoding.UTF8);//Default
        ...
        public static string[] GetFileList(string mask)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ex.Message.Trim() != "远程服务器返回错误: (550) 文件不可用(例如，未找到文件，无法访问文件)。")
                {
                 ...
                 //   LogHelper.WriteLog("ftp获取--》" + ex.Message.ToString());
                }
                return downloadFiles;
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string[] GetFileLists(string mask)
        {
            string[] downloadFiles;
            StringBuilder result = new StringBuilder();
            FtpWebRequest reqFTP;
        ...
        /// </summary>
        /// <returns></returns>
        public static string[] GetDirectoryList(string mak)
        {
            string[] drectory = GetFilesDetailList(mak);
            string m = string.Empty;
            foreach (string str in drectory)
            {
                int dirPos = str.IndexOf("<DIR>");
        ...
        public static void MakeDir(string dirName)
        {
            ...
            {
                LogHelper.WriteLog("ftp创建目录--》" + ex.Message);
            }
        }
        ...
        public static long GetFileSize(string filename)
        {
            ...
            {
               LogHelper.WriteLog("ftp获取文件大小--》" + ex.Message);
            }
            return fileSize;
        }
        ...
        public static void ReName(string currentFilename, string newFilename)
        {
            ...
            {
                LogHelper.WriteLog("ftp修改文件名称--》" + ex.Message);
            }
        }
            ...
            try{
                if (!string.IsNullOrEmpty(ftpServerIP) && !string.IsNullOrEmpty(folderToDelete) && !string.IsNullOrEmpty(ftpUserID) && !string.IsNullOrEmpty(ftpPassword))
                {
                 //   FtpWeb fw = new FtpWeb(ftpServerIP, folderToDelete, ftpUserID, ftpPassword);
                    //进入订单目录
                    GotoDirectory(folderToDelete, true);
                    //获取规格目录
